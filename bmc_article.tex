...
glue between high performace components, and thus these programming languages
need not themselves be designed for high performance~\cite{Ousterhout:1998fk}.
...
last years of the second millenium JavaScript was developed by web developers,
partly because it was more reliable than the browser's Java virtual
...
language for the web and the fact that it is somewhat of an industrial standard
